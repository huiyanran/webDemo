    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupYM(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    '<div class="date_btn_box">' +
                    '<div class=" lcalendar_cancel"></div>' +
                    '<div class=" lcalendar_finish"></div>' +
                    '</div>' +
                    '<div class="date_roll_mask">' +
                    '<div class="ym_roll">' +
                    '<div>' +
            ...
            function popupDateTime(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn lcalendar_finish"></div>' +
                    '</div>' +
                    '<div class="date_roll_mask">' +
            ...
            function finishMobileYM(e) {
                ...
                var date_mm = parseInt(Math.round(_self.gearDate.querySelector(".date_mm").getAttribute("val"))) + 1;
                date_mm = date_mm > 9 ? date_mm : '0' + date_mm;
                _self.trigger.value = (date_yy % passY + _self.minY)+"年"/* + "-" + date_mm*/;
                closeMobileCalendar(e);
            }
            //日期时间确认
            function finishMobileDateTime(e) {
                ...
                _self.trigger.value = (date_yy % passY + _self.minY) + "年" + date_mm + "月" + date_dd + "日"+" " + (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm;
                closeMobileCalendar(e);
            }
            //时间确认
